...
.Parameter ComputerName
    Specifies the name of the computer on which you want to initialize the associated Disk object. If Computername is not specified, the current computer is used.
