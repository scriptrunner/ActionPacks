...
<#
    ...
    .Parameter Folderscope
        Specifies the scope of the search by folder type
        [sr-de] Gibt den Bereich für die Suche nach dem Postfachtyp an

    .Parameter Archive
        Specifies whether to return the usage statistics of the archive mailbox that's associated with the mailbox or mail user
    ...
    .Parameter IncludeOldestAndNewestItems
        Specifies whether to return the dates of the oldest and newest items in each folder
    ...
    .Parameter IncludeSoftDeletedRecipients
        Specifies whether to include soft-deleted mailboxes in the results
