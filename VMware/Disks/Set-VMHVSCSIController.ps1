...
.Parameter TemplateName
    Specifies the virtual machine template from which you want to modify the SCSI controller

.Parameter SnapshotName
    Specifies the snapshot from which you want to modify the SCSI controller

.Parameter DiskName
    Specifies the name of the SCSI hard disk you want to modify the SCSI controller 

.Parameter ControllerName
    Specifies the names of the SCSI controllers you want to modify
