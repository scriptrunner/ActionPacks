...
try{
    ...
    Mount-Tools -VM $Script:machine -Server $Script:vmServer -ErrorAction Stop
    
    $Script:Output = Get-VMGuest -VM $Script:machine -Server $Script:vmServer -ErrorAction Stop `
