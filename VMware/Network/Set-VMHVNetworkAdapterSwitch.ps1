...
.Parameter SwitchName
    Specifies the name of a virtual switch to which you want to connect the network adapter
...
try{
    ...
    $Script:Output = Set-NetworkAdapter -Server $Script:vmServer -NetworkAdapter $Script:adapter -DistributedSwitch $vdSwitch -PortId $PortID -Confirm:$false -ErrorAction Stop | Select-Object *
