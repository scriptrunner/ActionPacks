...
.Parameter VMId
    Specifies the ID of the virtual machine you want to retrieve the resource configuration

.Parameter VMName
    Specifies the name of the virtual machine you want to retrieve the resource configuration 
#>
